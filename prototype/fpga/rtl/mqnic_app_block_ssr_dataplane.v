...
(
    ...
    parameter APP_ID = 32'h53535201,       // application block ID (must be unique for each block, lower values have higher priority for arbitration)
...
// check configuration
initial begin
    if (APP_ID != 32'h53535201) begin
        $error("Error: Invalid APP_ID (expected 32'h53535201, got 32'h%x) (instance %m)", APP_ID);
        $finish;
    end
end
